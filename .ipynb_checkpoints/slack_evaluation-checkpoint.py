...
if __name__=="__main__":
    ...
    print(f"true_prediction_s1: {true_prediction_s1}")
    print(f"false_prediction_s1: {false_prediction_s1}")
    print(f"true_prediction_s2: {true_prediction_s2}")
    print(f"false_prediction_s2: {false_prediction_s2}")
    
    print(f"Accuracy with slack of 1: {true_prediction_s1/(true_prediction_s1+false_prediction_s1)}")
    print(f"Accuracy with slack of 2: {true_prediction_s2/(true_prediction_s2+false_prediction_s2)}")